...
func Admin(v int) predicate.User {
...
func AdminEQ(v int) predicate.User {
	return predicate.User(sql.FieldEQ(FieldAdmin, v))
}

// AdminNEQ applies the NEQ predicate on the "admin" field.
func AdminNEQ(v int) predicate.User {
	return predicate.User(sql.FieldNEQ(FieldAdmin, v))
}

// AdminIn applies the In predicate on the "admin" field.
func AdminIn(vs ...int) predicate.User {
	return predicate.User(sql.FieldIn(FieldAdmin, vs...))
}

// AdminNotIn applies the NotIn predicate on the "admin" field.
func AdminNotIn(vs ...int) predicate.User {
	return predicate.User(sql.FieldNotIn(FieldAdmin, vs...))
}

// AdminGT applies the GT predicate on the "admin" field.
func AdminGT(v int) predicate.User {
	return predicate.User(sql.FieldGT(FieldAdmin, v))
}

// AdminGTE applies the GTE predicate on the "admin" field.
func AdminGTE(v int) predicate.User {
	return predicate.User(sql.FieldGTE(FieldAdmin, v))
}

// AdminLT applies the LT predicate on the "admin" field.
func AdminLT(v int) predicate.User {
	return predicate.User(sql.FieldLT(FieldAdmin, v))
}

// AdminLTE applies the LTE predicate on the "admin" field.
func AdminLTE(v int) predicate.User {
	return predicate.User(sql.FieldLTE(FieldAdmin, v))
}
