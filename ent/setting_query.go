...
func (sq *SettingQuery) FirstID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (sq *SettingQuery) FirstIDX(ctx context.Context) int64 {
...
func (sq *SettingQuery) OnlyID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (sq *SettingQuery) OnlyIDX(ctx context.Context) int64 {
...
func (sq *SettingQuery) IDs(ctx context.Context) (ids []int64, err error) {
...
func (sq *SettingQuery) IDsX(ctx context.Context) []int64 {
	ids, err := sq.IDs(ctx)
	if err != nil {
		panic(err)
	}
