...
func (Page) Fields() []ent.Field {
	return []ent.Field{
		...
		field.String("unique_id").NotEmpty().MaxLen(40).Immutable().Comment("页面唯一id"),
		...
		field.String("url").NotEmpty().MaxLen(2048).Comment("原始地址"),
		field.String("path").NotEmpty().MaxLen(500).Comment("完整本地文件地址"),
