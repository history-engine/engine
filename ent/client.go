...
func (c *Client) Use(hooks ...Hook) {
	for _, n := range []interface{ Use(...Hook) }{
		c.Alias, c.FileType, c.Host, c.Icon, c.Page, c.Setting, c.User,
	} {
		n.Use(hooks...)
	}
}
...
// UpdateOneID returns an update builder for the given id.
func (c *IconClient) UpdateOneID(id int64) *IconUpdateOne {
...
// DeleteOneID returns a builder for deleting the given entity by its id.
func (c *IconClient) DeleteOneID(id int64) *IconDeleteOne {
...
func (c *IconClient) Get(ctx context.Context, id int64) (*Icon, error) {
	return c.Query().Where(icon.ID(id)).Only(ctx)
}

// GetX is like Get, but panics if an error occurs.
func (c *IconClient) GetX(ctx context.Context, id int64) *Icon {
	obj, err := c.Get(ctx, id)
	if err != nil {
		panic(err)
	}
...
type (
	hooks struct {
		Alias, FileType, Host, Icon, Page, Setting, User []ent.Hook
	}
	inters struct {
		Alias, FileType, Host, Icon, Page, Setting, User []ent.Interceptor
	}
)
